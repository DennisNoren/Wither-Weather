...
##### - For the Butterworth high pass filter, you might want to select a higher filter frequency than the default, say 12, 13, or 14, which will smooth/generalize more. Moving the frequency below 8 might not be a useful transformation because it will accentuate the day-by-day variations. Note: There is a current bug where this filter will fail if there is missing data anywhere in the date range.  
